...
const EditEventDialog = ({ selectedEditEvent, open, onClose, onSave }) => {
  ...
  const [selectedMmber, setSelectedMmber] = useState([]);

  console.log("selected ******************", selectedEditEvent);
  ...
  /* function convertArray(arr) {
    console.log("arrrrrrrrrrrrrrrrrrrrrrrrrrrrrr", arr);
    const personsWithLabels = arr.map((person) => {
 ...
 /*  useEffect(() => {
    setSelectedMmber(convertArray(selectedEditEvent.members));
  }); */
  ...
  const dateStr = selectedEditEvent?.dac;
    ...
    <Dialog open={open} onClose={onClose}>
      ...
      <DialogContent>
        ...
        <Autocomplete
          ...
          defaultValue={selectedEditEvent?.responsible?.firstname}
        ...
        <Autocomplete
          ...
          getOptionLabel={(option) => option?.label || ""}
          defaultValue={selectedEditEvent?.president?.firstname}
