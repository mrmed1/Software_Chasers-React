describe("Profile Page ", () => {
    ...
    const GanikasToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2E2MDkwYzFhMDgzNGE1MWFjNTI0NmUiLCJyb2xlIjoiU1RVREVOVCIsImlzUmVzcG9uc2libGUiOmZhbHNlLCJpYXQiOjE2ODQ5NTE1MTN9.UytgYPI8REsty1Kk3xeE6-hc2cwFa3M2wRx7dqEUbxk"
    let Ganikas;
    ...
    beforeEach(() => {
      ...
      it("displays Ganikas information", () => {
        ...
        cy.getByData("fullnameText")
         .should("have.text", `${Ganikas?.firstname} ${Ganikas?.lastname}`);
      ...
      it("Update Ganikas information", () => {
        ...
        cy.get('.form > :nth-child(1) > :nth-child(3) > .ui > input').clear().type("saadimelek@gmail.com")
        cy.get(':nth-child(2) > :nth-child(1) > .ui > input').clear().type("Ganikas")
        cy.get(':nth-child(2) > :nth-child(2) > .ui > input').clear().type("pdnejoh00")
        cy.get(':nth-child(2) > :nth-child(3) > .ui > input').clear().type("pdnejoh00")
